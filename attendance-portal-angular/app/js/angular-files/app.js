...
var App = angular.module('attendancePortal', ['ngRoute', 'ngAnimate', 'ngStorage', 'ngCookies', 'pascalprecht.translate', 'ui.bootstrap', 'ui.router', 'oc.lazyLoad', 'cfp.loadingBar', 'ngSanitize', 'ngResource', 'ui.utils', 'ngTagsInput'])
    .run(["$rootScope", "$state", "$stateParams", '$window', '$templateCache', function ($rootScope, $state, $stateParams, $window, $templateCache) {
        ...
        $rootScope.app = {
            ...
            description: 'Attendance Portal Admin',
...
App
    ...
    .constant('APP_REQUIRES', {
        ...
        modules: [
            ...
            {name:'uiGmapgoogle-maps',files:['vendor/angular-google-maps/angular-google-maps.min.js','vendor/angular-google-maps/lodash.min.js']}
...
var checkCookie = function (x) {
    if(document.cookie.indexOf(cookie) >= 0){
        return true;
    }
    sessionStorage.removeItem(permArray);
    return false;
};
